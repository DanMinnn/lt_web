...
create database QLBanQuanAo_01
...
values ('SP1', N'Đầm dạ hội FDH', 'PL1', 100000, 'img_1.png', 'PLP1'),
		('SP2', N'Đầm công sở vải thô, dáng xòe', 'PL2', 100000, 'img_2.png', 'PLP2'),
		('SP3', N'Đầm công sở dáng A', 'PL2',100000, 'img_3.png', 'PLP2'),
		('SP4', N'Đầm maxi', 'PL2',200000, 'img_4.png', 'PLP1'),
		('SP5', N'Quần thiết kế', 'PL2',200000, 'img_5.png', 'PLP3');
